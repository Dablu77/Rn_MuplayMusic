                        ...
                        <View style={{ flexDirection: "row", justifyContent: 'space-between', paddingHorizontal: 15, top: 10, alignItems: 'center' }}>
                            <View style={{ alignItems: 'flex-start' }}>
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <Text style={{ color: Colors.Withe, left: 10, fontSize: fontPixel(18) }}>10,000</Text>
                                </View>
                            ...
                            <TouchableOpacity
                                ...
                                style={{ paddingVertical: 6, backgroundColor: Colors.Chinesepurple, width: widthPixel(80), alignItems: 'center', borderRadius: 4 }}>
                                <Text style={{ color: Colors.Withe, }}>Edit</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                ))}
